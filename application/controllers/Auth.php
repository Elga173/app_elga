...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config['smtp_user'] = 'elgadwinovianti06@gmail.com'; //email yg dirubah keamanannya
        $config['smtp_pass'] = 'agjgmvjdxhosihga';
        ...
        $this->email->from('elgadwinovianti06@gmail.com', 'web Programing SMKN 8 JEMBER');
...
public function forgotPassword()
{
    ...
    if ($this->form_validation->run() == false) {
        ...
        if ($user) {
            ...
            role="alert">Email is not registered or avtivated!</div>');
        }
    }
}
